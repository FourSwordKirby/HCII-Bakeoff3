...
final float screenPPI = 577f; //what is the DPI of the screen you are using
...
void setup() {
  ...
  size(1054, 2020); //set this, based on your sceen's PPI to be a 2x3.5" area.
...
//These are used to color the squares the same when they are close enough to each other.
